...
Java_ru_neurotech_neurosdk_channels_ElectrodesStateChannel_create(JNIEnv *env, jclass type,
                                                          jobject device) {
...
JNIEXPORT jobject
JNICALL
Java_ru_neurotech_neurosdk_channels_ElectrodesStateChannel_info(JNIEnv *env, jobject instance) {
...
JNIEXPORT void
JNICALL
Java_ru_neurotech_neurosdk_channels_ElectrodesStateChannel_init(JNIEnv *env, jobject instance) {
...
Java_ru_neurotech_neurosdk_channels_ElectrodesStateChannel_deleteNative(JNIEnv *env, jobject instance) {
    deleteNativeObject<JniElectrodesStateChannelWrap>(env, instance);
}

JNIEXPORT jobject JNICALL
Java_ru_neurotech_neurosdk_channels_ElectrodesStateChannel_underlyingDevice(JNIEnv *env, jobject instance) {
    auto &electrodesStateChannelWrap = *extract_pointer<JniElectrodesStateChannelWrap>(env, instance);
...
JNIEXPORT void JNICALL
Java_ru_neurotech_neurosdk_channels_ElectrodesStateChannel_setSamplingFrequency(JNIEnv *env,
                                                                        jobject instance,
                                                                        jfloat frequency) {
    auto &electrodesStateChannelWrap = *extract_pointer<JniElectrodesStateChannelWrap>(env, instance);
    try {
        electrodesStateChannelWrap->setSamplingFrequency(frequency);
    }
...
Java_ru_neurotech_neurosdk_channels_ElectrodesStateChannel_samplingFrequency(JNIEnv *env,
                                                                     jobject instance) {
    auto &electrodesStateChannelWrap = *extract_pointer<JniElectrodesStateChannelWrap>(env, instance);
...
JNIEXPORT jlong JNICALL
Java_ru_neurotech_neurosdk_channels_ElectrodesStateChannel_bufferSize(JNIEnv *env, jobject instance) {
    auto &electrodesStateChannelWrap = *extract_pointer<JniElectrodesStateChannelWrap>(env, instance);
    return saturation_cast<jlong>(electrodesStateChannelWrap->bufferSize());
}

JNIEXPORT jlong JNICALL
Java_ru_neurotech_neurosdk_channels_ElectrodesStateChannel_totalLength(JNIEnv *env, jobject instance) {
    auto &electrodesStateChannelWrap = *extract_pointer<JniElectrodesStateChannelWrap>(env, instance);
    return saturation_cast<jlong>(electrodesStateChannelWrap->totalLength());
}

JNIEXPORT jobjectArray JNICALL
Java_ru_neurotech_neurosdk_channels_ElectrodesStateChannel_readData(JNIEnv *env, jobject instance,
