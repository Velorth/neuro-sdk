...
Java_com_neuromd_neurosdk_channels_ConnectionStatsChannel_create(JNIEnv *env, jclass type,
                                                          jobject device) {
...
JNIEXPORT jobject
JNICALL
Java_com_neuromd_neurosdk_channels_ConnectionStatsChannel_info(JNIEnv *env, jobject instance) {
...
JNIEXPORT void
JNICALL
Java_com_neuromd_neurosdk_channels_ConnectionStatsChannel_init(JNIEnv *env, jobject instance) {
...
Java_com_neuromd_neurosdk_channels_ConnectionStatsChannel_deleteNative(JNIEnv *env, jobject instance) {
    deleteNativeObject<JniConnectionStatsChannelWrap>(env, instance);
}

JNIEXPORT jobject JNICALL
Java_com_neuromd_neurosdk_channels_ConnectionStatsChannel_underlyingDevice(JNIEnv *env, jobject instance) {
    auto &connectionStatsChannelWrap = *extract_pointer<JniConnectionStatsChannelWrap>(env, instance);
...
JNIEXPORT jlong JNICALL
Java_com_neuromd_neurosdk_channels_ConnectionStatsChannel_bufferSize(JNIEnv *env, jobject instance) {
    auto &connectionStatsChannelWrap = *extract_pointer<JniConnectionStatsChannelWrap>(env, instance);
    return saturation_cast<jlong>(connectionStatsChannelWrap->bufferSize());
}

JNIEXPORT jlong JNICALL
Java_com_neuromd_neurosdk_channels_ConnectionStatsChannel_totalLength(JNIEnv *env, jobject instance) {
    auto &connectionStatsChannelWrap = *extract_pointer<JniConnectionStatsChannelWrap>(env, instance);
    return saturation_cast<jlong>(connectionStatsChannelWrap->totalLength());
}

JNIEXPORT jobjectArray JNICALL
Java_com_neuromd_neurosdk_channels_ConnectionStatsChannel_readData(JNIEnv *env, jobject instance,
