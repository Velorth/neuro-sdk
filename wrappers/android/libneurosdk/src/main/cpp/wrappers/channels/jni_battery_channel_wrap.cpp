...
Java_com_neuromd_neurosdk_channels_BatteryChannel_create(JNIEnv *env, jclass type,
                                                          jobject device) {
...
JNIEXPORT jobject
JNICALL
Java_com_neuromd_neurosdk_channels_BatteryChannel_info(JNIEnv *env, jobject instance) {
...
JNIEXPORT void
JNICALL
Java_com_neuromd_neurosdk_channels_BatteryChannel_init(JNIEnv *env, jobject instance) {
...
Java_com_neuromd_neurosdk_channels_BatteryChannel_deleteNative(JNIEnv *env, jobject instance) {
    deleteNativeObject<JniBatteryChannelWrap>(env, instance);
}

JNIEXPORT jobject JNICALL
Java_com_neuromd_neurosdk_channels_BatteryChannel_underlyingDevice(JNIEnv *env, jobject instance) {
    auto &batteryChannelWrap = *extract_pointer<JniBatteryChannelWrap>(env, instance);
...
Java_com_neuromd_neurosdk_channels_BatteryChannel_samplingFrequency(JNIEnv *env,
                                                                     jobject instance) {
    auto &batteryChannelWrap = *extract_pointer<JniBatteryChannelWrap>(env, instance);
...
JNIEXPORT jlong JNICALL
Java_com_neuromd_neurosdk_channels_BatteryChannel_bufferSize(JNIEnv *env, jobject instance) {
    auto &batteryChannelWrap = *extract_pointer<JniBatteryChannelWrap>(env, instance);
    return saturation_cast<jlong>(batteryChannelWrap->bufferSize());
}

JNIEXPORT jlong JNICALL
Java_com_neuromd_neurosdk_channels_BatteryChannel_totalLength(JNIEnv *env, jobject instance) {
    auto &batteryChannelWrap = *extract_pointer<JniBatteryChannelWrap>(env, instance);
    return saturation_cast<jlong>(batteryChannelWrap->totalLength());
}

JNIEXPORT jobjectArray JNICALL
Java_com_neuromd_neurosdk_channels_BatteryChannel_readData(JNIEnv *env, jobject instance,
