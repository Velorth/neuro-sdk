...
JNIEXPORT void
JNICALL
Java_com_neuromd_neurosdk_Device_init(JNIEnv *env, jobject instance) {
...
Java_com_neuromd_neurosdk_Device_deleteDevice(JNIEnv *env, jobject instance) {
    deleteNativeObject<JniDeviceWrap>(env, instance);
}

JNIEXPORT void JNICALL
Java_com_neuromd_neurosdk_Device_connect(JNIEnv *env, jobject instance) {
...
JNIEXPORT void JNICALL
Java_com_neuromd_neurosdk_Device_disconnect(JNIEnv *env, jobject instance) {
    auto& devicePtr = *extract_pointer<JniDeviceWrap>(env, instance);
    devicePtr->disconnect();
}

JNIEXPORT jobjectArray JNICALL
Java_com_neuromd_neurosdk_Device_channels(JNIEnv *env, jobject instance) {
    auto& devicePtr = *extract_pointer<JniDeviceWrap>(env, instance);
...
JNIEXPORT jobjectArray JNICALL
Java_com_neuromd_neurosdk_Device_commands(JNIEnv *env, jobject instance) {
    auto& devicePtr = *extract_pointer<JniDeviceWrap>(env, instance);
...
JNIEXPORT jobjectArray JNICALL
Java_com_neuromd_neurosdk_Device_parameters(JNIEnv *env, jobject instance) {
    auto& devicePtr = *extract_pointer<JniDeviceWrap>(env, instance);
...
Java_com_neuromd_neurosdk_Device_setParam(JNIEnv *env, jobject instance, jobject param,
                                           jobject value) {
    auto& devicePtr = *extract_pointer<JniDeviceWrap>(env, instance);
...
Java_com_neuromd_neurosdk_Device_readParam(JNIEnv *env, jobject instance, jobject param) {
    auto& devicePtr = *extract_pointer<JniDeviceWrap>(env, instance);
    auto paramEnum = jni::enumFromJavaObj<Neuro::Parameter>(env, param);
...
JNIEXPORT jboolean JNICALL
Java_com_neuromd_neurosdk_Device_execute(JNIEnv *env, jobject instance, jobject cmd) {
    auto& devicePtr = *extract_pointer<JniDeviceWrap>(env, instance);
    try {
